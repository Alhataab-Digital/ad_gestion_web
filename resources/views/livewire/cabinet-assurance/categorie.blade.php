                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form class="row g-3" wire:submit.prevent='save'>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control" wire:model='code_categorie'
                                                    id="inputName5">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <input type="text" class="form-control" wire:model='libelle_categorie'
                                                    id="inputName5">
                        ...
                        <table class="table datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a wire:navigate href="/categorie/{{encrypt($categorie->id)}}/edit">
                                            <button type="button" class="btn btn-primary"><i
                                                    class="bi bi-pencil"></i></button>
                                        </a>
                                        <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                            data-bs-target="#deleteModal{{$categorie->id}}"><i
                                                class="bi bi-trash"></i></button>
                                        <div wire:ignore.self class="modal fade" id="deleteModal{{$categorie->id}}"
                                            tabindex="-1">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <!-- Vertical Form -->
                                                    <div class="modal-body">
                                                        <div class="alert alert-danger">
                                                            ...
                                                            suppression du categorie : {{ $categorie->code_categorie}}
                                                        </div>
                                                    </div>
