                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form class="row g-3" wire:submit.prevent='save'>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control" wire:model='code_groupe'
                                                    id="inputName5">
                                                @error('code_groupe')
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <input type="text" class="form-control" wire:model='libelle_groupe'
                                                    id="inputName5">
                        ...
                        <table class="table datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a wire:navigate href="/groupe/{{encrypt($groupe->id)}}/edit">
                                            <button type="button" class="btn btn-primary"><i
                                                    class="bi bi-pencil"></i></button>
                                        </a>
                                        <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                            data-bs-target="#deleteModal{{$groupe->id}}"><i
                                                class="bi bi-trash"></i></button>
                                        <div wire:ignore.self class="modal fade" id="deleteModal{{$groupe->id}}"
                                            tabindex="-1">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <!-- Vertical Form -->
                                                    <div class="modal-body">
                                                        <div class="alert alert-danger">
                                                            ...
                                                            suppression du groupe : {{ $groupe->libelle_groupe}}
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer text-center">
                                                        <button type="button" class="btn btn-secondary"
                                                            data-bs-dismiss="modal">Close</button>
                                                        <button type="submit"
                                                            wire:click='deleteConfirmation({{$groupe->id}})'
