                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3" wire:submit.prevent='saveSigne'>
                            ...
                            <div class="col-md-3">
                                <label for="inputName5" class="form-label">Taille (m)</label>
                                <input type="text" class="form-control" id="inputName5" wire:model='taille'>
                            </div>
                            <div class="col-md-3">
                                <label for="inputEmail5" class="form-label">Poid (kg) </label>
                                <input type="text" class="form-control" id="inputEmail5" wire:model='poid'>
                            </div>
                            <div class="col-md-6">
                                <label for="inputPassword5" class="form-label">IMC (Indice de Masse Corporelle) </label>
                                <input type="text" class="form-control" id="inputPassword5" wire:model='imc' disabled>
                            </div>
                            <div class="text-center text-white card-header bg-secondary">
                                Signe vitaux
                            </div>
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center ">
                                        ...
                                        <span class=" bg-secondary rounded-pill">
                                            ...
                                            <button type="button" class="btn btn-secondary btn-sm">
                                                <i class="bx bxs-printer"></i> imprimer
                                            </button>
                                        </span>
                                    </li>
                                </h5>
