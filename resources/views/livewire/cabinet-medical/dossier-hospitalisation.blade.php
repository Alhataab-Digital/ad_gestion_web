                    ...
                    <div class="card-body">
                        ...
                        <form class="row g-3" wire:submit.prevent='enregistrer'>
                            ...
                            <div class="col-md-12 bg-secondary text-white">
                                <label for="inputState" class="form-label">Motif hospitalisation</label>
                            ...
                            <div class="col-md-6 bg-secondary text-white">
                                <label for="inputState" class="form-label">Date Admission <span
                                        style="color: red">*</span></label>
                            ...
                            <div class="col-md-6 bg-secondary text-white">
                                <label for="inputState" class="form-label">Unite<span
                                        style="color: red">*</span></label>
                            ...
                            <div class="col-md-6 bg-secondary text-white">
                                <label for="inputState" class="form-label">Lits<span
                                        style="color: red">*</span></label>
                            ...
                            <div class="col-6 bg-secondary text-white">
                                <label for="inputAddress2" class="form-label">Tarif Hospitalisation<span
                                        style="color: red">*</span></label>
