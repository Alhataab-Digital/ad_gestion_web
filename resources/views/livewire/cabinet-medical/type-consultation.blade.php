                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form method="post" wire:submit.prevent='save'>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="col-md-12">
                                                    <label for="inputNanme5" class="form-label">type consultation medicale </label>
                                                ...
                                                <div class="col-md-12">
                                                    <label for="inputNanme5" class="form-label">tarif consultation medicale </label>
                                                    <input type="text" wire:model="tarif_consultation" class="form-control"
                                                        id="inputNanme5">
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:right">{{ number_format($type_consultation->tarif_consultation,2,","," ").'
