...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>REPARTITION DIVIDENDE SUR L'ACTIVITE </h1>
      <nav>
        <ol class="breadcrumb">
                  ...
                  <div class="card-body">
                    ...
                    <h5 class="bg-secondary text-white">
                        <table>
                            ...
                            <tr>
                                <td>
                                    <input class="form-control" type="text" name="total_activite" id="total_activite" value="{{$activite_vehicule->montant_vente}}" required>
                                </td>
                                <td>
                                    <input class="form-control" type="text"  name="total_depense" value="{{$activite_vehicule->total_depense}}" id="total_depense"  readonly>
                                </td>
                                <td>
                                    <input class="form-control" type="text"  name="montant_benefice" value="{{$activite_vehicule->montant_benefice}}" id="montant_benefice"  readonly>
                                </td>
                                <td>
