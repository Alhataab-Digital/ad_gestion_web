...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>DEPENSE ACTIVITE</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Accueil</a></li>
          <li class="breadcrumb-item">Activite investissement</li>
          <li class="breadcrumb-item active">Nouvelle depense activite</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        <div class="col-lg-10">
           ...
           <div class="card">
                ...
                <div class="card-body">
                <h5 class="card-title">Formulaire d'enregistrement de depense activité</h5>
                <p>
                ...
                <form method="post" action="{{ route('activite_investissement.store') }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <select class="form-select" aria-label="Default select example" name="type_activite" require>
                            ...
                            <option value="{{ $activite->id }}">{{ $activite->type_activite->type_activite }}</option>
                            @endforeach
                        </select>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label">secteur de depense </label>
                        <div class="col-sm-10">
                        <select class="form-select" aria-label="Default select example" name="type_activite" require>
                            <option >Choisir...</option>
                    ...
                    <div class="row mb-3">
                    <label for="inputText" class="col-sm-2 col-form-label">Montant decaisser</label>
                    <div class="col-sm-10">
