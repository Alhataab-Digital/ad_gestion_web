        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="card">
              ...
              <!-- Vertical Form -->
              <form class="row g-3" method="post" action="{{ route('type_activite_investissement.store') }}" >
                  @csrf
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body" >
                          <div class="col-12">
                              ...
                              <input type="text" name="type_activite" class="form-control" id="inputNanme4">
                          </div>
                ...
                <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <th scope="row">{{ $type_activite->id}}</th>
                        <td>{{ $type_activite->type_activite}}</td>
                        <td>
                            <a href="{{ route('type_activite_investissement.edit',encrypt($type_activite->id)) }}">
