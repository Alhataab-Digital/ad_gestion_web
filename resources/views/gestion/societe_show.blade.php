    ...
    <div class="row">
      ...
      <div class="col-lg-3">
            ...
            <div class="modal fade" id="largeModal" tabindex="-1">
              <div class="modal-dialog modal-sm">
                <div class="modal-content">
                  ...
                  <form action="{{ route('logo.update',encrypt($societe->id)) }}" method="post"
                      ...
                      <div class="row">
                        <div class="col-md-12 col-sm-12">
                          <div class="form-group">
                            ...
                            <input type="file" name="logo" value="{{old('logo')?? $societe->logo }}"
                              class="form-control">
                          </div>
                        </div>
                      </div>
        ...
        <div class="card">
          <div class="card-body " style="background-color: silver">
            <div class="col-md-12">
              <label for="validationDefault01" class="form-label">Montant compte societe <span
                  style="color:red">*</span></label>
              <input type="text" value="{{number_format($societe->compte_societe ,2,"
                ,"," ").' '.$agence->devise->unite }}" class="form-control" readonly>
            </div>
            <div class="col-md-12">
              <label for="validationDefault03" class="form-label">Montant compte de securite <span
                  style="color:red">*</span></label>
              <input type="text" value="{{number_format($societe->compte_securite ,2,"
                ,"," ").' '.$agence->devise->unite }}" class="form-control" readonly>
            </div>
            <!-- End Browser Default Validation -->
          </div>
