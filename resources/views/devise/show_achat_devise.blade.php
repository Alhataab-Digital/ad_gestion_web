        ...
        <div class="card">
          <div class="card-body">
            ...
            <form class="row g-3" >
                ...
                <div class="col-md-12">
                    <input type="hidden" name="f_id" value="{{ $operation->client->id }}" class="form-control" id="telephone">
                </div>
                <div class="col-md-12">
              ...
              <div class="col-md-6" id="montant">
                <label for="inputCity" class="form-label">Montant devise achat</label>
                <input type="text" name="montant" value="{{ number_format($operation->montant_operation/$operation->taux,2,","," ").' '.$operation->devise->unite }}" class="form-control" id="montant_v" >
              </div>
              <div class="col-md-6">
              ...
              <div class="text-center">
                <a href="{{ route('achat_devise.print',$operation->id) }}">
