                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('agence.update', encrypt($agence->id)) }}" method="post" class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="nom" value="{{ $agence->nom }}" class="form-control"
                                    id="inputNanme4">
                            </div>
                            <div class="col-12">
                                    ...
                                    <div class="modal-dialog modal-sm">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="col-12">
                                                    {{-- <label for="inputAddress" class="form-label">Devise par
                                                        defaut</label> --}}
                                                    <input type="hidden" name="taux"
                                                        value="{{ $agence->devise->devise }}" class="form-control"
                                                        id="inputAddress" placeholder="1234 Main St">
                                                </div>
                                                <div class="col-12">
                                                    ...
                                                    <select class="form-select" id="validationDefault04"
                                                        name="devise_id" required>
                                                        <option selected disabled value="">Choose...</option>
                                                        @foreach ($devises as $devise)
                                                        <option value="{{ $devise->id }}">
                                                            {{ $devise->devise . ' : ' . $devise->monnaie }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-12">
                                                    <label for="inputAddress" class="form-label">Taux</label>
                                                    <input type="number" step="0.00001" name="taux" class="form-control"
                                                        id="inputAddress" placeholder="1234">
                                                </div>
                                            </div>
                            ...
                            <thead>
                                <tr>
                                    <form class="row g-3" method="post" action="{{ route('edit.devise') }}">
                                        ...
                                        <th><button type="submit" class="btn btn-primary"> <i
                                                    class="bi bi-pencil"></i></button></th>
                                    </form>
                                </tr>
                            </thead>
                        </table>
