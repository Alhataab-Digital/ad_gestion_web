                ...
                <div class="col-md-3">
                    ...
                    <select class="form-select" id="" name="fournisseur" required>
                      ...
                      @foreach ($fournisseurs as $fournisseur )
                        <option value="{{ $fournisseur->id }}">{{ $fournisseur->nom_fournisseur.'  '.$fournisseur->telephone }}</option>
                      @endforeach
                    </select>
                      ...
                      <table class="table table-borderless " >
                          ...
                          <tbody class=" text-white" id="show_item" id="tab">
                              <tr>
                                  ...
                                  <th scope="row">
                                      <input class="form-control" onchange="prixU();" type="text" name="qte[]" value="1" id="qte_a" >
                                  </th>
