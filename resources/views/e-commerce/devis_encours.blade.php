                        ...
                        <h5 class="card-title ">
                            ...
                            <form method="post" action="{{ route('facture.store') }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="" name="activite" required>
                                        <option value="{{ $activite_investissement->id }}">
                                            {{ 'Activite N° '.$activite_investissement->id.' :
                                            '.$activite_investissement->type_activite->type_activite }}
                                        </option>
                                    </select>
                                </div>
                                @endif
                        ...
                        <div>
                            ...
                            <table class="table table-borderless ">
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <select class="form-select" name="produit[]" id="produit">
                                                <option data-prix="{{ $detail_devis->produit->prix_unitaire_achat }}"
                                                    value="{{ $detail_devis->produit->id }}">{{
                                                    $detail_devis->produit->nom_produit }}</option>
                                            </select>
                                        </th>
                                        <th scope="row">
                                            <input class="form-control" type="text" name="qte[]"
                                                value="{{ $detail_devis->quantite_demandee }}" id="qte_v" readonly>
                                        </th>
                                        <th scope="row" id="prix_u">
                                            <input class="form-control" type="text" name="prix[]"
                                                value="{{ $detail_devis->prix_unitaire_demande }}" id="prix_v" readonly>
                                        </th>
                                        <th scope="row">
                                            <input class="form-control" type="text" name="total[]"
                                                value="{{ $detail_devis->quantite_demandee*$detail_devis->prix_unitaire_demande}}"
                                                id="total" readonly>
                                        </th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input class="form-control" type="text" name="montant_ht"
                                            value="{{ $total_ht->total }}" id="montant_ht">
                                    </td>
                                    <td></td>
                                </tr>
                            ...
                            <table class="table table-borderless ">
                                <tr>
                                    ...
                                    <th>
                                        ...
                                        <input class="form-control" type="text" value="{{ $devis->client->nom_client }}"
                                            class="form-control">
                                    </th>
                                    <th>
                                        <label for="inputText" class="col-sm-6 col-form-label">Telephone</label>
                                        <input class="form-control" type="text" value="{{ $devis->client->telephone  }}"
                                            class="form-control">
                                    </th>
                                    <th>
                                        <label for="inputText" class="col-sm-6 col-form-label">Adresse</label>
                                        <input class="form-control" type="text" value="{{ $devis->client->adresse  }}"
                                            class="form-control">
                                    </th>
                                </tr>
                            </table>
                            <div>
                                ...
                                <div class="text-left">
                                    ...
                                    <button class="btn btn-success"><i class="bi bi-check-square-fill"></i> Confirmer le
                                        devis</button>
                                    @endif
                                </div>
