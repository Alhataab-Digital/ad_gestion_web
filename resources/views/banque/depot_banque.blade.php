    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">DEPOT BANQUE</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form  method="post" action="{{ route('banque.depot.create') }}">
                @csrf
                <fieldset class="row mb-3">
                  <legend class="col-form-label col-sm-3 pt-0">Source</legend>
                  <div class="col-sm-9">
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="source" id="gridRadios1" value="caisse">
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        <!-- <a href="{{ route('banque.depot.valider',$operation->id) }}">
                            <button type="button" class="btn btn-primary"><i class="bi bi-pencil"></i></button>
                        </a>
                        <a href="{{ route('banque.depot.edit',$operation->id) }}">
                            <button type="button" class="btn btn-primary"><i class="bi bi-pencil"></i></button>
                        </a> -->
                      @if($caisse->date_comptable==$operation->date_comptable)
                        <a href="{{ route('banque.depot.delete',$operation->id) }}">
