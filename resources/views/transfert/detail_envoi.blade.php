                ...
                <div class="card">
                    ...
                    <form class="row g-3" method="post" action="{{ route('envoi.store') }}">
                        @csrf
                            ...
                            <input type="text" name="devise" value="{{ $devise_agence->taux }}" class="form-control" id="inputName5">
                            @endif
                            @endforeach --}}
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="nom_client" value="{{ $client->nom_client }}" class="form-control" id="inputName5">
                            </div>
                            <div class="col-md-6">
                                <label for="inputEmail5" class="form-label">Telephone expediteur</label>
                                <input type="text" name="telephone" value="{{ $client->telephone }}" class="form-control" id="inputEmail5" readonly="true">
                            </div>
                            <div class="bg-primary">
                            ...
                            <div class="col-md-6" >
                                ...
                                <input onchange="deduction()" type="text" name="montant" class="form-control" id="montant" >
                            </div>
                            <div class="col-md-6" >
                                <label for="inputCity" class="form-label">frais d'envoi (1% du montant)</label>
                                <input onkeyup="deduction()" type="text" name="frais" class="form-control" id="frais" readonly>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="bg-primary">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" name="telephone_destinataire" class="form-control" id="inputAddress2" >
                                </div>
                            <div class="bg-primary">
                            <hr>
                            </div>
                            <input type="hidden" name="agence_id"  value="{{ $agence->id }}"  class="form-control" id="inputAddress2" >
                            <div class="col-md-3">
