                        ...
                        @csrf
                            ...
                            <div class="bg-primary">
                                ...
                                <div class="col-md-6" >
                                    ...
                                    <input  type="text" value="{{ number_format(round($operation->montant_ttc/$operation->taux_echange),2,","," ").' '.$agence->devise->unite}}" class="form-control" id="montant" >
                                    @endif
                                    @if($operation->type_envoi==0)
                                    <input  type="text" value="{{ number_format(round($operation->montant/$operation->taux_echange),2,","," ").' '.$agence->devise->unite}}" class="form-control" id="montant" >
                                    @endif
                                </div>
                            <div class="bg-primary">
                            ...
                            <div class="col-md-4">
                                ...
                                <select  class="form-select" name="type_piece" id="">
                                    @foreach ($pieces as $piece )
                                        @if ($operation->type_piece_id==$piece->id)

                                            <option value="">{{ $piece->type_piece }}</option>
                            ...
                            <div class="col-md-6" >
                                ...
                                <input  type="text" name="numero_piece"  value="{{ $operation->numero_piece }}"  class="form-control" id="" >
                            </div>
                            ...
                            <div class="text-center">
                                <a href="{{ route('retrait.print',$operation->id) }}">
