        ...
        @if (Auth::user()->role_id == '0' ||
            ...
            <li class="nav-item">
                <a class="nav-link collapse" data-bs-target="#banque-nav" data-bs-toggle="collapse" href="#">
                    <i class="ri ri-building-line"></i><span>Gestion banque</span><i
    ...
    @if (Auth::user()->role_id == '0' || Auth::user()->role_id == '1' || Auth::user()->role_id == '2')
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-journal-text"></i><span>Gestion investisseur</span><i
                    class="bi bi-chevron-down ms-auto"></i>
            </a>
    ...
    @if (Auth::user()->role_id == '0' ||
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#activite-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-layout-text-window-reverse"></i><span>Activités d'investissement</span><i
                    class="bi bi-chevron-down ms-auto"></i>
            </a>
    ...
    @if (Auth::user()->role_id == '0' ||
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#vehicule-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-layout-text-window-reverse"></i><span>Activités vehicule</span><i
                    class="bi bi-chevron-down ms-auto"></i>
            </a>
    ...
    @if (Auth::user()->role_id == '0' ||
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#cr-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-journal-text"></i><span>Commandes & Réceptions</span><i
                    class="bi bi-chevron-down ms-auto"></i>
            </a>
      ...
      <li>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#doc-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-journal-text"></i><span>Devis & Facturations</span><i
                    class="bi bi-chevron-down ms-auto"></i>
            </a>
      ...
      <li>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-journal-text"></i><span>Reglements & Recouvrements</span><i
                    class="bi bi-chevron-down ms-auto"></i>
            </a>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#pro-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-journal-text"></i><span>Articles /Categories /Produits</span><i
                    class="bi bi-chevron-down ms-auto"></i>
            </a>
