            ...
            <div class="col-lg-6 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form  method="post" action="{{ route('registre.store') }}"   class="row g-3 needs-validation" novalidate>
                    @csrf
                    <div class="col-12">
                        <label for="yourName" class="form-label">Type de Gestion</label>
                        <select name="gestion" class="form-control" id="">
                                <option value="">Choix du type de gestion</option>
                      ...
                      <div class="col-12">
                        ...
                        <div class="invalid-feedback">S'il vous plait entrez votre prenom!</div>
                      </div>
                    <div class="col-12">
                        <label for="yourUsername" class="form-label">Votre Adresse</label>
                          <input type="text" name="adresse" class="form-control" id="yourUsername" required>
                    ...
                    <div class="col-12">
                        ...
                        <div class="invalid-feedback">S'il vous plait entrez votre mot de pass!</div>
                    </div>
                      <div class="col-12">
                        <label for="yourPassword" class="form-label">comfimer mot de passe</label>
                        <input type="password" name="passwordconfirme" class="form-control" id="yourPassword" required>
                        <div class="invalid-feedback">S'il vous plait confirmez votre mot de pass!</div>
                    </div>
                    <div class="col-12">
              ...
              <div class="credits">
                ...
                Conçus par <a href="https://alhataab.com/">Alhataab Digital</a>
              </div>
