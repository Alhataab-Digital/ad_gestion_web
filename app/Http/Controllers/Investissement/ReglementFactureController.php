...
class ReglementFactureController extends Controller
{
    ...
    public function index()
    {
        ...
        if (isset(Caisse::where('user_id', $id)->first(['id'])->id)) {
            ...
            return view('investissement.reglement_facture', compact('caisse'));
        }
    ...
    public function numero_client(Request $request)
    {
        ...
        return view('investissement.facture_impayer', compact('factures', 'client'));
    }
    ...
    public function paiement_facture($id)
    {
        ...
        return view('investissement.paiement_facture', compact('facture', 'reglement_facture', 'reglements', 'operations', 'client', 'activite_investissements', 'detail_factures', 'total_ht'));
    }
    /**
                            ...
                            if (Caisse::where('user_id', $user_id)->first(['id'])->id) {
                                ...
                                if ($facture->montant_total <= $request->montant) {
                                    ...
                                    OperationReglementFacture::create([
                                        ...
                                        'reglement_facture_id' => $reglement_facture->id,
                                    ]);
                                    $facture->update([
                                        'etat' => 'terminer',
                                        'montant_regle' => $montant_regle,
