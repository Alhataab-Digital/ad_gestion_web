...
class DeviseController extends Controller
{
    ...
    public function index()
    {
        ...
        $devises = Devise::all();
        return view('money_change.index', compact('devises'));
    }
    ...
    public function edit(string $id)
    {
        ...
        if (Auth::check()) {
            ...
            return view('money_change.edit', compact('devise'));
        }
    ...
    //     return view('money_change.taux', compact('devises','devise_agences'));
    // }
