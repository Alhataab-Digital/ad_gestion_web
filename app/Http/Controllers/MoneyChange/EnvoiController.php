...
class EnvoiController extends Controller
{
    ...
    public function index()
    {
        ...
        if (isset(Caisse::where('user_id', $id)->first(['id'])->id)) {
            ...
            return view('money_change.transfert.envoi', compact('caisse', 'agence', 'operations','regions'));
        }
    ...
    public function store(Request $request)
    {
        ...
        if (Caisse::where('user_id', $user_id)->first(['id'])->id) {
             ...
             */
             ...
             $agence = Agence::find($agence_id);
             $solde_compte=$agence->compte_agence+$request->frais;
             $agence->update([
    ...
    public function show(string $id)
    {
        ...
        return view('money_change.transfert.show_envoi', compact('operation', 'agence', 'agence_destination'));
    }
    ...
    public function numero_client(Request $request)
    {
        ...
        if (isset(Client::where('telephone', $tel)->first(['id'])->id)) {
            ...
            $regions = Region::all();
            return view('money_change.transfert.detail_envoi', compact('client', 'devise_agences', 'agence', 'regions', 'reglements'));
            /**
            ...
            return view('money_change.transfert.detail_envoi', compact('client', 'devise_agences', 'regions', 'agence', 'reglements'));
    ...
    public function print($id)
    {
        ...
        $pdf = PDF::setOptions(['isHtml5ParserEnabled' => true, 'isRemoteEnabled' => true])
            ->loadView('print.change.recu_envoi', compact('operation', 'agence', 'agence_destination'));
