...
class AchatDeviseController extends Controller
{
    ...
    public function index()
    {
        ...
        if (isset(Caisse::where('user_id', $id)->first(['id'])->id)) {
            ...
            return view('money_change.achat_devise', compact('caisse', 'operations', 'agence','regions'));
        }
    ...
    public function show(string $id)
    {
        ...
        $agence = Agence::find($agence_id);
        return view('money_change.show_achat_devise', compact('operation', 'agence'));
    }
    ...
    public function client(Request $request)
    {
        ...
        if (isset(Client::where('telephone', $tel)->first(['id'])->id)) {
            ...
            return view('money_change.detail_achat_devise', compact('client', 'devise_agences', 'reglements'));
            /**
    ...
    public function print($id)
    {
        ...
        $pdf = PDF::setOptions(['isHtml5ParserEnabled' => true, 'isRemoteEnabled' => true])
            ->loadView('print.change.recu_achat_devise', compact('operation', 'agence'));
