...
class VenteDeviseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (Caisse::where('user_id', $user_id)->first(['id'])->id) {
            ...
            if (isset(Stock::where('caisse_id', $caisse_id)->where('devise_id', $request->devise)->first(['id'])->id)) {
                 ...
                 * montant saisie
                 */
                $montant = round($request->montant / $request->taux);
                /**
                 * montant total
                 */
    ...
    public function client(Request $request)
    {
        ...
        if (isset(client::where('telephone', $tel)->first(['id'])->id)) {
            ...
            return view('devise.detail_vente_devise', compact('client', 'devise_agences', 'reglements', 'agence'));
            /**
            ...
            $devises = Devise::all();
            $reglements = TypeReglement::all();
            return view('devise.detail_vente_devise', compact('client', 'devise_agences', 'reglements'));
