...
return [
    ...
    'backup' => [
        ...
        // 'dump_command_path' => 'C:\wamp64\bin\mysql\mysql8.0.31\bin',
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => 'digitalalhataab@gmail.com',

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'hrouane90@gmail.com'),
                'name' => env('MAIL_FROM_NAME', 'AD GESTION'),
            ],
        ],
